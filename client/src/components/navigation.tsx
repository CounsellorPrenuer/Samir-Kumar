...
export default function Navigation() {
  ...
  // All navigation links are now in a single array
  const allNavLinks = [
  ...
  // Track active section with scrollspy using the unified links array
  const allSectionIds = allNavLinks.map(link => link.href.substring(1));
